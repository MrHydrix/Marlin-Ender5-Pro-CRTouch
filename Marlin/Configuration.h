...
#define STRING_CONFIG_H_AUTHOR "(MrHydrix, Ender-5 Pro)" // Who made the changes.
...
//MrHydrix - These were done from my previous PID Autotune cycles
  ...
  #else
    #define DEFAULT_Kp  27.7243
    #define DEFAULT_Ki   2.8880
    #define DEFAULT_Kd 66.5384
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //MrHydrix - These were done from my previous PID Autotune cycles
  #define DEFAULT_bedKp 159.3710 
  #define DEFAULT_bedKi 20.9699
  #define DEFAULT_bedKd 807.4799
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 111 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.8, -8.8, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define AVOID_OBSTACLES
    ...
    #define CLIP_W  21  // Bed clip width, should be padded a few mm over its physical size
    #define CLIP_H  10  // Bed clip height, should be padded a few mm over its physical size
